...
def registerCellularNoiseShader():
	...
	try:
		...
		print 'Registered Procedural Voronoi Node : Cellular Noise'
	except Exception as exc:
		print 'Error Registered Procedural Voronoi Node: Cellular Noise : ' + str(exc)
...
def registerGaborNoiseShader():
	...
	try:
		...
		print 'Registered Procedural Noise Node : Paintable Gabor Noise'
	except Exception as exc:
		print 'Error Registered Procedural Noise Node : Paintable Gabor Noise : ' + str(exc)

def registerPerlinNoiseShader():
	"Register a new custom shader module that implements perlin noise"
	# Register the code as a new custom shader module
	try:
		mari.gl_render.registerCustomProceduralLayerFromXMLFile("Procedural/Custom/Perlin/Perlin Noise",mari.resources.path(mari.resources.USER_SCRIPTS) + "/NodeLibrary/Procedurals/Perlin/DT3D_PerlinNoise.xml")
		print 'Registered Procedural Perlin Node : Perlin Noise'
	except Exception as exc:
		print 'Error Registered Procedural Perlin Node : Perlin Noise : ' + str(exc)
...
def registerBrownianNoiseShader():
	...
	try:
		...
		print 'Registered Procedural FBM Node : Brownian Noise'
	except Exception as exc:
		print 'Error Registered Procedural FBM Node : Brownian Noise : ' + str(exc)

def registerTurbulenceNoiseShader():
	"Register a new custom shader module that implements Turbulence noise"
	# Register the code as a new custom shader module
	try:
		mari.gl_render.registerCustomProceduralLayerFromXMLFile("Procedural/Custom/Perlin/Turbulence Noise",mari.resources.path(mari.resources.USER_SCRIPTS) + "/NodeLibrary/Procedurals/Perlin/DT3D_TurbulenceNoise.xml")
		print 'Registered Procedural Perlin Node : Turbulence Noise'
	except Exception as exc:
		print 'Error Registered Procedural Perlin Node : Turbulence Noise : ' + str(exc)

def registerInigoNoiseShader():
	"Register a new custom shader module that implements Inigo noise"
	# Register the code as a new custom shader module
	try:
		mari.gl_render.registerCustomProceduralLayerFromXMLFile("Procedural/Custom/Perlin/Inigo Noise",mari.resources.path(mari.resources.USER_SCRIPTS) + "/NodeLibrary/Procedurals/Perlin/DT3D_InigoMultiNoise.xml")
		print 'Registered Procedural Perlin Node : Inigo Noise'
	except Exception as exc:
		print 'Error Registered Procedural Perlin Node : Inigo Noise : ' + str(exc)
...
def registerRidgedNoiseShader():
	...
	try:
		...
		print 'Registered Procedural multifractal Node : Ridged Noise'
	except Exception as exc:
		print 'Error Registered Procedural multifractal Node : Ridged Noise : ' + str(exc)
