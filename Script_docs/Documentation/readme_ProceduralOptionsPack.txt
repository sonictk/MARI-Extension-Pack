...
This is a modification of the default Mari Procedurals. Added functionality includes SEED and Transform (rotate,translate, scale) controls
...
Please download and install the MARI Function Library V1.0 or higher at 
