...
A standalone shader with Environment Maps and Energy Conservation mimicking the mia_material_x from
Maya, 3dsmax etc. in look and handling.

Features include environment mapping, transparency approximation, reflection/refraction.
...
The shader can be added via the Add Shader Option in the Shader Palette
