...
Node to Merge Normal Maps. Apply it as adjustment layer in a stack for a specific layer (NOT in the channel as global adjustment layer)
...
The Node will appear under the Custom Folder in the Adjustment Layer Dialog.
